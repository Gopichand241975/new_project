...
TAMPER_BLACKOUT_THRESHOLD = 15   # mean pixel intensity below this = likely covered/block
...
class TamperMonitor:
    """Flags a camera as tampered if its feed goes dark/blank for a sustained
    period, so covering a camera doesn't just silently disable detection."""
